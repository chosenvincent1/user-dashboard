            ...
            <section className="md:w-[50%] flex flex-col md:justify-center ">
                ...
                <form className="md:max-w-[360px] md:mx-auto " >
                    ...
                    <div className="flex gap-[10px] justify-center text-[14px] ">
                        ...
                        <a href="" className="text-[#27779B] font-[600] ">Sign Up</a>
                    </div>
                </form>
            </section>

            <section style={{backgroundImage: `url('/images/login-image.png')`}} className="hidden md:block w-[50%] h-screen bg-center bg-cover bg-no-repeat " >
            </section>
        </main>
    )
}